  ...
  return (
    <>
      <header className={s.header}>
        ...
        <img className={s.imgUser } src="https://avatars.githubusercontent.com/u/79940603?v=4" alt="Imagem do usuário" onClick={()=> setMenuAberto(!menuAberto)} />
      </header>
      <nav className={menuAberto ? s.navUser : s.closedNavUser}>
        <Link to={"/usuario"} onClick={() => setMenuAberto(false)}>Gilcélio Júnior</Link>
