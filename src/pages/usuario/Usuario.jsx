...
const Usuario = () => {
  return (
    <main className={s.main}>
      <section>
        <img src="https://avatars.githubusercontent.com/u/79940603?v=4" alt="Imagem do perfil do usuario" />

        <div className={s.div}>
          <h1>Gilcélio Júnior</h1>
          ...
          <ul className={s.ulInfo}>
            <li><IoLocationOutline /> Brasília - DF</li>
            <li><MdOutlineEmail /> gilceliojr.dev@gmail.com</li>
